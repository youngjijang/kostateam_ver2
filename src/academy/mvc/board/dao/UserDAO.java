...
public interface UserDAO {
	...
	/**
	 * 로그인 - 로그인이 되면 SessionSet객체안에 있는 Set에 Session을 저장한다
	 * 강사일 경우 kind = teacher, 학생일 경우 kind = student 로 픽스
	 ...
	 * 강사일 경우 kind = teacher, 학생일 경우 kind = student 로 픽스
	 */
	int userJoin(String kind, String userId, int userPwd, String userName, String userTel, String thing) throws SQLException;
